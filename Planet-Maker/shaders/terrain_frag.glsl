...
// ____________ Classic Perlin Noise ________________
...
// ____________ Cellular Noise ________________
...
void main() {
  ...
  vec3 c_b = color_beach - 0.05 * generate_noise(100.0 * pos + seed);
  ...
  diffusecolor = mix(c_d, c_b, beach);
